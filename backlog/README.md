...
| [US-081](sprint/current/done/US-081-a-test-remembers-what-worked.md) | A test remembers what worked | ✅ **Done** 2026-08-12, 20/21 — release gate dropped, ships unmeasured | US-046 |
...
| [US-082](unscheduled/US-082-trust-the-cost-estimate.md) | Prove the cost estimate, then show it again | 📋 Planned | P3 | US-046 |
