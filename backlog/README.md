...
| [US-031](sprint/current/US-031-license-and-public-repo.md) | License the code and open the repo | 🧱 Repo side shipped (2026-07-25) — AGPL `LICENSE`, DCO, gitleaks clean over all 114 commits; the public flip + lowercase rename left | — |
| [US-032](sprint/current/US-032-release-pipeline-and-image.md) | CI on every push, a published image on every tag | 🧱 Repo side shipped, unverified (2026-07-25) — `ci.yml`, `release.yml`, `docker-compose.release.yml`; no workflow has run yet | US-031 |
